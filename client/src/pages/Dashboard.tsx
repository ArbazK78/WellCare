...
import BookingWaitingState from "@/components/BookingWaitingState";
  ...
  const saveProfileChanges = () => {
    if (!hasProfileChanged) {
      toast({
        ...
        description: "You haven't updated any profile fields.",
      });
      return;
    }
    ...
    if (window.confirm("Are you sure you want to cancel this booking?")) {
      try {
        ...
        if (response.status === 200) {
          ...
          // If you have a context function to update bookings, you might want to call it here
                              ...
                              <div className="flex flex-col md:flex-row">
                                ...
                                <div className="md:w-1/4 mb-4 md:mb-0">
                                  <div className="flex items-center space-x-4">
                                    <div className="w-12 h-12 rounded-full overflow-hidden">
                                      <img
                                        src={booking.guide?.image || "http://googleusercontent.com/image_generation_content/0"}
                                        alt={booking.guide?.name}
                                        className="object-cover w-full h-full"
                                      />
                                    </div>
                                    <div>
                                      <h3 className="font-medium">{booking.guide?.name || "Guide"}</h3>
                                      <div className="flex items-center text-yellow-500">
                                        <span>{booking.guide?.rating || "5"}</span>
                                ...
                                <div className="md:w-1/4 mt-4 md:mt-0 flex md:justify-end items-center">
                                  <div className="space-y-2">
                                    <Button variant="outline" size="sm" className="w-full" onClick={() => completeBooking(booking._id)}>
                                      Contact Guide
                                    </Button>
                                    <Button
                                      variant="outline"
