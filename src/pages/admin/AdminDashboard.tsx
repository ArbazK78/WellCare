...
type GuideWithPassword = Guide & { password: string };
...
const AdminDashboard = () => {
  ...
  const updateGuideStatus = (guideId: string, status: GuideStatus) => {
    const updatedGuides = guides.map(guide => 
      guide.id === guideId ? { ...guide, status } : guide
    );
                                ...
                                <DialogContent>
                                  ...
                                  <DialogFooter className="flex justify-between">
                                    <Button
                                      ...
                                      onClick={() => {
                                        if (selectedGuide) {
                                          updateGuideStatus(selectedGuide.id, "rejected");
                                        }
                                      }}
                                    >
                                    ...
                                    <Button
                                      onClick={() => {
                                        if (selectedGuide) {
                                          updateGuideStatus(selectedGuide.id, "approved");
                                        }
                                      }}
                                    >
